...
const Hero = () => {
    return (
        <div className={"flex  md:flex-row sm:flex-col min-h-max items-center justify-center bg-[#faedeb] m-7"}>
             <div className=" md:mx-16 w-100">
                ...
                <button className="mx-5 md:mx-14 mb-6 mt-2 md:mt-4 bg-green-500 hover:bg-green-600 px-4 md:px-6 text-white py-1 md:py-2 rounded-full">
                    Shop Collection
                </button>
            </div>
